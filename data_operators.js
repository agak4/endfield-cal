const DATA_OPERATORS = [
    //   - type: '공격력 증가', '물리 피해', '아츠 피해', '열기 피해', '전기 피해', '냉기 피해', '자연 피해', '불균형 목표에 주는 피해' (장착 오퍼가 주는 피해 증가)
    ...
    //            - skilltype: '배틀 스킬' | '연계 스킬' | '궁극기' (선택 시 해당 스킬만 적용, 미지정 시 3종 모두 적용)
    ...
    // skill 작성 규칙:
    //   skilltype : '일반 공격' | '배틀 스킬' | '연계 스킬' | '궁극기'
    //   dmg       : 기본 배율 문자열, 예) '348%'
...

    {
        ...
        skill: [
            ...
            { skilltype: '연계 스킬', element: 'phys', dmg: '100%', type: '오리지늄 봉인', target: '적', desc: '팀 내 다른 오퍼레이터의 연계 스킬이 피해를 줄 때 사용할 수 있습니다. 적의 근처로 돌진하여 대상에게 물리 피해를 주고 오리지늄 결정을 부착하며 일정 시간 봉인합니다. 물리 이상과 방어 불능 상태를 부여하면 오리지늄 결정을 소모하고 추가로 물리 피해를 줍니다.' },
    ...
    },
    {
        ...
        skill: [
            ...
            { skilltype: '배틀 스킬', element: 'nature', dmg: '320%', type: [{ type: '물리 취약', val: '20%', target: '적' }, { type: '아츠 취약', val: '20%', target: '적' }], desc: '돌리 씨를 타고 목표를 향해 돌진하여 자연 피해를 줍니다. 목표가 부식 상태일 때, 부식 상태를 소모하고, 대상에게 30초간 물리 취약과 아츠 취약 상태를 부여합니다.' },
    ...
    },
    {
        ...
        skill: [
            ...
            { skilltype: '배틀 스킬', element: 'heat', dmg: '230%', type: '열기 부착', target: '적', bonus: { trigger: ['연소', '감전'], val: '850%' }, desc: '목표를 연속으로 사격하여 소량의 열기 피해를 주고, 마지막 한 발은 열기 부착 상태를 부여합니다. 목표가 연소 또는 감전 상태일 경우 열기 부착 상태를 부여하지 않고, 해당 상태를 소모하여 추가로 1회 사격하며, 대량의 열기 피해를 줍니다.' },
    ...
    },
    {
        ...
        skill: [
            ...
            { skilltype: '연계 스킬', element: 'cryo', dmg: '320%', bonus: { trigger: '냉기 부착', base: '0%', perStack: '240%' }, desc: '적에게 냉기 부착 3스택 혹은 그 이상이 쌓였을 때 사용할 수 있습니다. 목표한 적에게 얼음송곳을 응결시킨 다음 산산이 조각냅니다. 목표에 쌓인 냉기 부착을 전부 소모하고, 대상에게 냉기 부착의 스택 수치에 따른 냉기 피해를 주며, 소모한 스택 수치에 따라 궁극기 에너지를 획득합니다.' },
