const DATA_GEAR = [
  ...
  { id: 'gear_6', name: '탁류 화염 절단기', part: 'kit', set: 'set_joryu', stat1: 'int', val1: 32, val1_f: 41, stat2: 'str', val2: 21, val2_f: 27, trait: { type: '기본 공격 피해', val: '27.6%', val_f: '35.9%' } },
  ...
  { id: 'gear_23', name: 'M. I. 경찰용 팔찌', part: 'gloves', set: 'set_mi_police', stat1: 'int', val1: 65, val1_f: 84, stat2: 'agi', val2: 43, val2_f: 55, trait: { type: '기본 공격 피해', val: '23%', val_f: '29.9%' } },
  ...
  { id: 'gear_27', name: 'M. I. 경찰용 망토', part: 'armor', set: 'set_mi_police', stat1: 'int', val1: 87, val1_f: 113, stat2: 'agi', val2: 58, val2_f: 75, trait: { type: '기본 공격 피해', val: '13.8%', val_f: '17.9%' } },
