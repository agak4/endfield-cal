const DATA_GEAR = [
  ...
  { id: 'gear_49', name: '본 크러셔 마스크', part: 'kit', set: 'set_bone_crusher', stat1: 'agi', val1: 32, val1_f: 41, stat2: 'str', val2: 21, val2_f: 27, trait: { type: '불균형 피해', val: 41.4, val_f: 53.8 } },
  ...
  { id: 'gear_57', name: '경량 초자연 보호판', part: 'armor', set: 'set_light_super', stat1: 'str', val1: 87, val1_f: 113, stat2: 'wil', val2: 58, val2_f: 75, trait: { type: '불균형 피해', val: 20.7, val_f: 26.9 } },
