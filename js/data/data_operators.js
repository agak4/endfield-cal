...
const DATA_OPERATORS = [
    ...
    },
    {
        ...
        skill: [
            ...
            },
            {
                ...
                levels: {
                    M0: { dmg: '380%', type: [{ type: '물리 취약', val: '6%', target: '적' }, { type: '넘어뜨리기', target: '적' }] },
                    M1: { dmg: '400%', type: [{ type: '물리 취약', val: '8%', target: '적' }, { type: '넘어뜨리기', target: '적' }] },
                    M2: { dmg: '420%', type: [{ type: '물리 취약', val: '10%', target: '적' }, { type: '넘어뜨리기', target: '적' }] },
            ...
            },
            {
                ...
                levels: {
                    M0: { dmg: '650%', type: ['넘어뜨리기'], bonus: [{ triggerTarget: ['연타'], val: '500%' }] },
                    M1: { dmg: '700%', type: ['넘어뜨리기'], bonus: [{ triggerTarget: ['연타'], val: '530%' }] },
                    M2: { dmg: '750%', type: ['넘어뜨리기'], bonus: [{ triggerTarget: ['연타'], val: '560%' }] },
    ...
    },
    {
        ...
        skill: [
            ...
            { skillType: ['강화 일반 공격'], element: 'heat', dmg: '1044%', desc: '모든 공격이 열기 피해를 주며, 3단계 일반 공격은 열기 부착 상태를 부여합니다.' },
