...
const DATA_OPERATORS = [
    ...
    },
    {
        ...
        talents: [
            [{ desc: '쇄빙 효과를 발동할 때마다, 다음에 사용한 배틀 스킬 서스테인이 스킬 게이지를 15포인트 반환합니다. <span style="color: #727272">해당 효과는 중첩되지 않습니다.</span>' }],
    ...
    },
    {
        ...
        skill: [
            ...
            {
                skillType: ['배틀 스킬'], element: 'cryo', desc: '지원 결정체를 소환하여 20초 동안 메인 컨트롤 오퍼레이터를 따라다닙니다. 메인 컨트롤 오퍼레이터가 적에게 강력한 일격 피해를 줄 때, 지원 결정체가 생명력을 회복시켜 줍니다. 해당 효과는 최대 2회 발동하며, 의지는 치유량을 추가로 증가시킵니다. 만약 회복 효과가 발동했을 때, 메인 컨트롤 오퍼레이터의 생명력이 최대치에 도달한 상태라면, 25초간 대상에게 아츠 증폭을 부여합니다. <span style="color: #727272">해당 효과는 중첩되지 않습니다.</span>',
                levels: {
        ...
        talents: [
            [{ type: ['받는 냉기 피해'], val: '10%', target: '적', desc: '연계 스킬 스트레스 테스트가 적에게 명중했을 때, 목표가 냉기 부착 혹은 동결 상태일 경우, 받는 냉기 피해 +10%, 5초 동안 지속. <span style="color: #727272">해당 효과는 중첩되지 않습니다.</span>' }],
    ...
    },
    {
        ...
        talents: [
            ...
            [{ type: ['공격력 증가'], val: '20%', desc: '20%의 확률로 아츠 피해 면역, 이후 자기 공격력 +20%, 10초 동안 지속. <span style="color: #727272">해당 효과는 중첩되지 않습니다.</span>' }]
        ],
        potential: [
    ...
    },
    {
        ...
        talents: [
            [{ type: ['냉기 취약'], val: '4%', trigger: ['냉기 부착'], target: '적', stack: 4, desc: '라스트 라이트가 임의의 아츠 부착을 소모할 때, 해당 목표에 소모한 아츠 부착의 스택 수치×4%만큼의 냉기 취약을 부여합니다. 15초 동안 지속. <span style="color: #727272">해당 효과는 중첩되지 않습니다.</span>' }],
    ...
    },
    {
        ...
        potential: [
            [{ type: ['물리 피해'], val: '30%', desc: '궁극기 채 썰어 웍에 넣기!로 1명 이상의 적을 처치했을 때, 판이 주는 물리 피해 +30%, 15초 동안 지속. <span style="color: #727272">해당 효과는 중첩되지 않습니다.</span>' }],
    ...
    },
    {
        ...
        talents: [
            [
                {
                    type: ['전기 피해'], val: '0%', target: '팀', scaling: { stat: 'int', ratio: '0.08%', max: null }, desc: '배틀 스킬 질풍 섬광을 사용하여 3회의 추가 효과를 발동했을 때, 자신의 지능에 따라 팀 전체의 전기 피해가 증가합니다. 지능 1포인트당 +0.08%, 15초 동안 지속. <span style="color: #727272">해당 효과는 중첩되지 않습니다.</span>'
                }
            ],
    ...
    },
    {
        ...
        potential: [
            ...
            [{ type: ['공격력 증가'], val: '15%', target: '팀', desc: '연계 스킬 얼음 낚시 기술을 사용하여 진귀한 린수를 낚았을 때, 팀 전체 공격력 +15%, 10초 동안 지속. <span style="color: #727272">해당 효과는 중첩되지 않습니다.</span>' }],
