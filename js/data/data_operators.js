...
const DATA_OPERATORS = [

    {
        ...
        talents: [
            [{ type: ['공격력 증가'], val: '30%', desc: '적에게 부착한 오리지늄 결정이 소모됐을 때, 자신의 공격력 +30%<br><span style="color: #727272">15초 동안 지속, 해당 효과는 중첩되지 않습니다.</span>' }],
            [{ type: ['받는 물리 피해'], val: '20%', target: '적', trigger: ['오리지늄 결정'], desc: '오리지늄 결정을 부착한 적이 받는 물리 피해 +20%' }]
        ],
        potential: [
            [{ desc: '배틀 스킬 구성 시퀀스가 오리지늄 결정을 소모했을 때, 스킬 게이지를 50포인트 반환합니다.' }],
            [{ type: ['공격력 증가'], val: '15%', target: '팀', targetFilter: '자신 제외', desc: '재능 "본질 붕괴" 효과 강화: 자신이 공격력 증가 효과를 획득할 때, 다른 아군 오퍼레이터가 공격력 증가 효과의 절반을 획득합니다.' }],
            [{ desc: '???' }],
            [{ desc: '???' }],
            [{ desc: '???' }]
        ]
    ...
    },
    {
        ...
        talents: [
            [{ desc: '쇄빙 효과를 발동할 때마다, 다음에 사용한 배틀 스킬 서스테인이 스킬 게이지를 15포인트 반환합니다.<br><span style="color: #727272">해당 효과는 중첩되지 않습니다.</span>' }],
    ...
    },
    {
        ...
        talents: [
            [{ type: ['궁극기 충전 효율'], val: '7%', target: '팀', targetClass: ['guard', 'caster', 'supporter'], desc: '필드에 있을 때, 팀 내 모든 아군 가드, 캐스터, 서포터 오퍼레이터의 궁극기 충전 효율 +7%' }],
            [{
    ...
    },
    {
        ...
        skill: [
            ...
            {
                skillType: ['배틀 스킬'], element: 'cryo', desc: '지원 결정체를 소환하여 20초 동안 메인 컨트롤 오퍼레이터를 따라다닙니다. 메인 컨트롤 오퍼레이터가 적에게 강력한 일격 피해를 줄 때, 지원 결정체가 생명력을 회복시켜 줍니다. 해당 효과는 최대 2회 발동하며, 의지는 치유량을 추가로 증가시킵니다. 만약 회복 효과가 발동했을 때, 메인 컨트롤 오퍼레이터의 생명력이 최대치에 도달한 상태라면, 25초간 대상에게 아츠 증폭을 부여합니다.<br><span style="color: #727272">해당 효과는 중첩되지 않습니다.</span>',
                levels: {
            ...
            {
                skillType: ['연계 스킬'], element: 'cryo', desc: '지원 결정체의 생명력 회복 횟수를 모두 소모했을 때 사용할 수 있습니다. 짧게 차지하여 지원 결정체를 적에게 투척해 냉기 피해를 주고 냉기 부착 상태를 부여합니다.',
                levels: {
        ...
        talents: [
            [{ type: ['받는 냉기 피해'], val: '10%', target: '적', desc: '연계 스킬 스트레스 테스트가 적에게 명중했을 때, 목표가 냉기 부착 혹은 동결 상태일 경우, 받는 냉기 피해 +10%, 5초 동안 지속.<br><span style="color: #727272">해당 효과는 중첩되지 않습니다.</span>' }],
    ...
    },
    {
        ...
        talents: [
            [{ type: ['불균형 목표에 주는 피해'], val: '30%', triggerTarget: '불균형', desc: '불균형 상태의 적에게 주는 피해 +30%' }],
        ...
        potential: [
            ...
            [{ type: ['상태 이상 배율'], targetAbnormal: '감전', val: '33.3%', desc: '연계 스킬 실시간 프로토콜 · 연쇄 섬광이 부여하는 감전의 적이 받는 아츠 피해 증가 효과가 기존의 1.33배로 증가' }],
    ...
    },
    {
        ...
        talents: [
            ...
            [{ type: ['공격력 증가'], val: '20%', desc: '20%의 확률로 아츠 피해 면역, 이후 자기 공격력 +20%, 10초 동안 지속.<br><span style="color: #727272">해당 효과는 중첩되지 않습니다.</span>' }]
        ],
        potential: [
    ...
    },
    {
        ...
        potential: [
            [{ type: ['추가 공격 피해 배율 증가'], val: '20%', skillType: ['배틀 스킬'], desc: '배틀 스킬 불타오르는 화염의 추가 공격 피해 배율이 기존의 1.2배로 증가하고, 명중했을 때 스킬 게이지 20포인트를 반환합니다.' }],
    ...
    },
    {
        ...
        potential: [
            [{ type: ['물리 피해'], val: '30%', desc: '궁극기 채 썰어 웍에 넣기!로 1명 이상의 적을 처치했을 때, 판이 주는 물리 피해 +30%, 15초 동안 지속.<br><span style="color: #727272">해당 효과는 중첩되지 않습니다.</span>' }],
    ...
    },
    {
        ...
        talents: [
            [
                {
                    type: ['전기 피해'], val: '0%', target: '팀', scaling: { stat: 'int', ratio: '0.08%', max: null }, desc: '배틀 스킬 질풍 섬광을 사용하여 3회의 추가 효과를 발동했을 때, 자신의 지능에 따라 팀 전체의 전기 피해가 증가합니다. 지능 1포인트당 +0.08%, 15초 동안 지속.<br><span style="color: #727272">해당 효과는 중첩되지 않습니다.</span>'
                }
            ],
    ...
    },
    {
        ...
        skill: [
            ...
            {
                skillType: ['강화 연계 스킬'], masterySource: '연계 스킬', element: 'phys', desc: '10% 확률로 진귀한 린수를 낚을 수 있으며, 피해가 대폭 증가하고 추가로 스킬 게이지를 10포인트 회복합니다.',
                levels: {
        ...
        potential: [
            ...
            [{ type: ['공격력 증가'], val: '15%', target: '팀', desc: '연계 스킬 얼음 낚시 기술을 사용하여 진귀한 린수를 낚았을 때, 팀 전체 공격력 +15%, 10초 동안 지속.<br><span style="color: #727272">해당 효과는 중첩되지 않습니다.</span>' }],
    ...
    },
    {
        ...
        type: 'arts',
        element: 'cryo',
        stats: { str: 123, agi: 239, int: 85, wil: 102 },
        usableWeapons: ['handcannon'],
        specialStack: { name: '와류', max: 2, triggers: ['와류'] },
        skill: [
            {
                skillType: ['일반 공격'], element: 'cryo', desc: '적에게 최대 5단 공격을 하여 냉기 피해를 줍니다.',
                levels: {
            ...
            {
                skillType: ['연계 스킬'], element: 'cryo', desc: '적이 냉기 부착을 부여받았거나 아츠 폭발 피해를 받았을 때 발동할 수 있습니다. 강력한 물줄기를 방출해 전방의 적을 관통하며 냉기 피해를 주고, 와류 하나를 생성합니다.<br><span style="color: #727272">필드에는 최대 두 개의 와류만 존재할 수 있습니다.</span>',
                levels: {
                    M0: { dmg: '192%', type: ['와류'] },
                    M1: { dmg: '205%', type: ['와류'] },
                    M2: { dmg: '221%', type: ['와류'] },
            ...
            {
                skillType: ['궁극기'], element: 'cryo', cost: 90, desc: '탕탕이 안대를 벗어 던지고 눈 속에 깃든 고대의 진을 발동합니다. 범위 내의 적은 일정 시간 동안 움직일 수 없으며, 지속적으로 냉기 피해를 받습니다. 고대의 진은 나타난 직후부터 서서히 변화를 시작해 변화가 끝날 때 거대한 파도를 일으키고 범위 내의 적에게 대량의 냉기 피해를 줍니다. 메인 컨트롤 오퍼레이터가 고대의 진 내에서 낙하 공격을 사용하면, 변화하던 고대의 진이 그 변화를 중단합니다. 이어서 거대한 파도를 일으키고, 이때 파도가 주는 냉기 피해가 증가합니다.',
                levels: {
                    M0: { dmg: '576%' },
                    M1: { dmg: '616%' },
                    M2: { dmg: '664%' },
        ...
        talents: [
            [{ desc: '와류 주변 5미터 범위 내, 아군 오퍼레이터는 20% 가속을 획득하고, 적은 40% 감속을 받습니다. 범위를 벗어난 뒤에도 해당 효과는 3초 동안 지속됩니다.' }],
            [{ desc: '메인 컨트롤 오퍼레이터가 고대의 진 내에서 낙하 공격을 사용하면, 변화하던 고대의 진이 그 변화를 중단합니다. 이어서 용오름 1개를 생성하며, 주변에 와류가 존재할 경우 이를 소모하여 추가로 용오름을 생성합니다.<br>이때 생성한 용오름은 배틀 스킬 우당탕탕 파도!와 동일한 효과를 가지고 있으며, 주는 피해 +60%' }]
        ],
        potential: [
            [{ type: ['스킬 배율 증가'], val: '20%', skillType: ['연계 스킬'], desc: '연계 스킬 야, 강물! 도와줘!의 피해 배율이 기존의 1.2배로 증가하며, 쿨타임 -2초.<br>배틀 스킬 우당탕탕 파도!로 와류 한 곳을 소모하여 용오름이 생성될 때마다, 추가로 스킬 게이지 5포인트를 반환합니다.' }],
            [{ type: ['스탯'], stats: 'agi', val: 20 }, { type: ['냉기 피해'], val: '10%', desc: '민첩 +20, 냉기 피해 +10%' }],
            [{ type: ['스킬 배율 증가'], val: '10%', skillType: ['배틀 스킬'], desc: '배틀 스킬 우당탕탕 파도!의 피해 배율이 기존의 1.1배로 증가하며, 동시에 여러 개의 용오름이 생성될 때 부여하는 아츠 취약 효과가 추가로 +5%' }],
            [{ type: ['궁극기 에너지 감소'], val: '15%', skillType: ['궁극기'], desc: '궁극기 대당가께서 지켜보고 계신다!의 사용에 필요한 궁극기 에너지 -15%' }],
            [{ type: ['스킬 배율 증가'], val: '15%', skillType: ['궁극기'], desc: '궁극기 대당가께서 지켜보고 계신다!의 피해 배율이 기존의 1.15배로 증가합니다.<br>재능 풍랑의 주재자 효과 강화: 궁극기 대당가께서 지켜보고 계신다!로 생성된 용오름의 피해 증가 추가로 +80%' }, { type: ['주는 피해'], val: '80%', skillType: ['강화 궁극기'], applyToBonusHit: true }]
        ]
    },
    {
        id: 'Rossi',
        ...
        type: 'phys',
        element: null,
        stats: { str: 97, agi: 236, int: 118, wil: 89 },
        usableWeapons: ['sword'],
        skill: [
            {
                skillType: ['일반 공격'], element: 'phys', desc: '적에게 최대 5단 공격을 하여 물리 피해를 줍니다',
            ...
            {
                skillType: ['배틀 스킬'], element: 'phys', desc: '목표를 향해 돌진하여 물리 피해를 주고 띄우기 피해를 줍니다. 만약 목표가 이미 방어 불능 상태를 보유하고 있으면, 추가로 울프팀의 진주가 발동해 목표에 돌진하며 열기 피해를 줍니다.',
                levels: {
                    M0: { dmg: '154%', type: ['띄우기'], bonus: [{ triggerTarget: ['방어 불능'], val: '230%', element: 'heat' }] },
                    M1: { dmg: '164%', type: ['띄우기'], bonus: [{ triggerTarget: ['방어 불능'], val: '246%', element: 'heat' }] },
                    M2: { dmg: '177%', type: ['띄우기'], bonus: [{ triggerTarget: ['방어 불능'], val: '265%', element: 'heat' }] },
                    M3: { dmg: '192%', type: ['띄우기'], bonus: [{ triggerTarget: ['방어 불능'], val: '288%', element: 'heat' }] }
                }
            },
            {
            ...
            {
                skillType: ['궁극기'], element: 'heat', cost: 110, desc: '망토를 휘날리며 재빠르게 찌릅니다. 짧은 시간 동안 목표에 여러 차례 열기 피해를 준 후, 증시 단검으로 2단 베기를 하여 대량의 열기 피해를 주고 열기 부착을 부여합니다.<br><span style="color: #727272">이번 스킬이 만약 치명타 피해를 줬을 경우, 더 강한 치명타 피해를 줍니다.</span>',
                levels: {
                    M0: { dmg: '1275%', type: ['열기 부착', { type: '치명타 피해', val: '60%', skillType: ['궁극기'] }] },
                    M1: { dmg: '1381%', type: ['열기 부착', { type: '치명타 피해', val: '60%', skillType: ['궁극기'] }] },
                    M2: { dmg: '1473%', type: ['열기 부착', { type: '치명타 피해', val: '60%', skillType: ['궁극기'] }] },
                    M3: { dmg: '1600%', type: ['열기 부착', { type: '치명타 피해', val: '60%', skillType: ['궁극기'] }] }
                }
            }
        ],
        talents: [
            [{ type: ['물리 피해'], dmg: '750%' }, { type: ['받는 물리 피해', '받는 열기 피해'], target: '적', val: '12%', desc: '배틀 스킬 울프팀의 진주가 피해를 준 후, 목표에게 늑대의 발톱 상태를 부여합니다. 25초 동안 동안 지속되며, 해당 효과는 중첩되지 않습니다. 늑대의 발톱이 지속되는 동안, 목표는 매초 로시 공격력 30%의 물리 피해를 받고, 받는 물리 피해와 열기 피해 +12%.' }],
            [{ type: ['열기 데미지'], element: 'heat', dmg: '24%', desc: '로시가 늑대의 발톱 상태의 적에게 스킬을 사용해 치명타 피해를 주면, 추가로 공격력 24%의 열기 피해를 1회 주고, [지능*0.08]만큼 자신의 생명력을 회복합니다. 목표가 연소 상태도 보유하고 있다면, 위의 피해 및 치유 효과가 1.5배로 증가합니다.' }]
        ],
        potential: [
            [{ type: ['스킬 배율 증가'], val: '15%', skillType: ['배틀 스킬', '연계 스킬'], desc: '배틀 스킬 붉은색의 그림자와 연계 스킬 그림자가 타오르는 순간의 피해 배율이 기존의 1.15배로 증가합니다. 배틀 스킬로 인해 나타난 울프팀의 진주는 적을 명중한 후, 10포인트의 스킬 게이지를 반환합니다.' }],
            [{ type: ['스탯'], stats: 'agi', val: 20 }, { type: ['치명타 확률'], val: '7%', desc: '민첩 +20, 치명타 확률 +7%' }],
            [{ type: [''], val: '', target: '', desc: '재능 끓어오르는 피 효과 강화: 기초 피해 배율 +8%, 기초 생명력을 +[지능*0.04]만큼 회복.' }],
            [{ type: ['궁극기 에너지 감소'], val: '15%', skillType: ['궁극기'], desc: '궁극기 기습 "날카로운 발톱"의 사용에 필요한 궁극기 에너지 -15%' }],
            [{ type: ['스킬 배율 증가'], val: '10%', skillType: ['궁극기'] }, { type: ['치명타 피해'], val: '30%', skillType: ['궁극기'], desc: '궁극기 기습 "날카로운 발톱"의 피해 배율이 기존의 1.1배, 추가로 치명타 피해 +30%.' }]
        ]
    }
];
