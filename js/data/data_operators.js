...
const DATA_OPERATORS = [
    ...
    },
    {
        ...
        talents: [
            [{ type: ['공격력 증가'], val: '40%', desc: '스킬이 적에게 명중할 때마다 공격력 +8%, 10초 동안 지속, 해당 효과는 최대 5스택까지 중첩됩니다.' }],
    ...
    },
    {
        ...
        skill: [
            ...
            },
            {
                ...
                levels: {
                    M0: { dmg: '350%', type: ['냉기 부착'], target: '적' },
                    M1: { dmg: '350%', type: ['냉기 부착'], target: '적' },
                    M2: { dmg: '270%', type: ['냉기 부착'], target: '적' },
            ...
            },
            {
                ...
                levels: {
                    M0: { dmg: '360%', type: [{ type: '물리 취약', val: '15%', target: '적' }, { type: '강제 띄우기', target: '적' }], bonus: [{ trigger: ['동결'], val: '270%' }] },
                    M1: { dmg: '360%', type: [{ type: '물리 취약', val: '15%', target: '적' }, { type: '강제 띄우기', target: '적' }], bonus: [{ trigger: ['동결'], val: '270%' }] },
                    M2: { dmg: '360%', type: [{ type: '물리 취약', val: '15%', target: '적' }, { type: '강제 띄우기', target: '적' }], bonus: [{ trigger: ['동결'], val: '270%' }] },
            ...
            },
            {
                ...
                levels: {
                    M0: { dmg: '1100%', bonus: [{ trigger: ['물리 취약'], type: ['강제 띄우기'], target: '적' }] },
                    M1: { dmg: '1100%', bonus: [{ trigger: ['물리 취약'], type: ['강제 띄우기'], target: '적' }] },
                    M2: { dmg: '1100%', bonus: [{ trigger: ['물리 취약'], type: ['강제 띄우기'], target: '적' }] },
    ...
    },
    {
        ...
        skill: [
            ...
            },
            {
                ...
                levels: {
                    M0: { dmg: '390%', type: ['넘어뜨리기'], target: '적' },
                    M1: { dmg: '390%', type: ['넘어뜨리기'], target: '적' },
                    M2: { dmg: '390%', type: ['넘어뜨리기'], target: '적' },
            ...
            },
            {
                ...
                levels: {
                    M0: { dmg: '230%', type: [{ type: '치유', target: '팀' }, { type: '넘어뜨리기', target: '적' }] },
                    M1: { dmg: '230%', type: [{ type: '치유', target: '팀' }, { type: '넘어뜨리기', target: '적' }] },
                    M2: { dmg: '230%', type: [{ type: '치유', target: '팀' }, { type: '넘어뜨리기', target: '적' }] },
            ...
            },
            {
                ...
                levels: {
                    M0: { dmg: '650%', type: ['보호'], target: '팀' },
                    M1: { dmg: '650%', type: ['보호'], target: '팀' },
                    M2: { dmg: '650%', type: ['보호'], target: '팀' },
        ...
        talents: [
            ...
            [{ type: ['공격력 증가'], val: '27%', desc: '적에게 피해를 받았을 때, 공격력 +9%, 7초 동안 지속. 해당 효과는 최대 3스택까지 중첩됩니다.' }]
        ],
        potential: [
    ...
    },
    {
        ...
        skill: [
            ...
            },
            {
                ...
                levels: {
                    M0: { dmg: '450%', type: [{ type: '비호', target: '팀' }, { type: '냉기 부착', target: '적' }] },
                    M1: { dmg: '450%', type: [{ type: '비호', target: '팀' }, { type: '냉기 부착', target: '적' }] },
                    M2: { dmg: '450%', type: [{ type: '비호', target: '팀' }, { type: '냉기 부착', target: '적' }] },
            ...
            },
            {
                ...
                levels: {
                    M0: { dmg: '450%', type: ['동결 부여'], target: '적' },
                    M1: { dmg: '450%', type: ['동결 부여'], target: '적' },
                    M2: { dmg: '450%', type: ['동결 부여'], target: '적' },
    ...
    },
    {
        ...
        skill: [
            ...
            },
            {
                ...
                levels: {
                    M0: { dmg: '400%', type: [{ type: '비호', target: '팀' }, { type: '방어 불능 부여', target: '적' }] },
                    M1: { dmg: '400%', type: [{ type: '비호', target: '팀' }, { type: '방어 불능 부여', target: '적' }] },
                    M2: { dmg: '400%', type: [{ type: '비호', target: '팀' }, { type: '방어 불능 부여', target: '적' }] },
            ...
            },
            {
                ...
                levels: {
                    M0: { dmg: '280%', type: ['보호'], target: '팀' },
                    M1: { dmg: '280%', type: ['보호'], target: '팀' },
                    M2: { dmg: '280%', type: ['보호'], target: '팀' },
            ...
            },
            {
                ...
                levels: {
                    M0: { dmg: '1005%', type: [{ type: '허약', target: '적' }, { type: '방어 불능 부여', target: '적' }] },
                    M1: { dmg: '1005%', type: [{ type: '허약', target: '적' }, { type: '방어 불능 부여', target: '적' }] },
                    M2: { dmg: '1005%', type: [{ type: '허약', target: '적' }, { type: '방어 불능 부여', target: '적' }] },
    ...
    },
    {
        ...
        skill: [
            ...
            },
            {
                ...
                levels: {
                    M0: { dmg: '349%', type: ['자연 부착'], target: '적' },
                    M1: { dmg: '349%', type: ['자연 부착'], target: '적' },
                    M2: { dmg: '349%', type: ['자연 부착'], target: '적' },
            ...
            },
            {
                ...
                levels: {
                    M0: { dmg: '315%', type: ['강제 띄우기'], target: '적' },
                    M1: { dmg: '315%', type: ['강제 띄우기'], target: '적' },
                    M2: { dmg: '315%', type: ['강제 띄우기'], target: '적' },
            ...
            },
            {
                ...
                levels: {
                    M0: { dmg: '750%', type: [{ type: '자연 부착', target: '적' }, { type: '아츠 취약', val: '30%', target: '적', trigger: ['방어 불능'], perStack: '3%' }, { type: '감속', target: '적' }] },
                    M1: { dmg: '750%', type: [{ type: '자연 부착', target: '적' }, { type: '아츠 취약', val: '30%', target: '적', trigger: ['방어 불능'], perStack: '3%' }, { type: '감속', target: '적' }] },
                    M2: { dmg: '750%', type: [{ type: '자연 부착', target: '적' }, { type: '아츠 취약', val: '30%', target: '적', trigger: ['방어 불능'], perStack: '3%' }, { type: '감속', target: '적' }] },
    ...
    },
    {
        ...
        skill: [
            ...
            },
            {
                ...
                levels: {
                    M0: { dmg: '320%', type: [{ type: '부식 소모' }, { type: '물리 취약', val: '20%', target: '적' }, { type: '아츠 취약', val: '20%', target: '적' }] },
                    M1: { dmg: '320%', type: [{ type: '부식 소모' }, { type: '물리 취약', val: '20%', target: '적' }, { type: '아츠 취약', val: '20%', target: '적' }] },
                    M2: { dmg: '320%', type: [{ type: '부식 소모' }, { type: '물리 취약', val: '20%', target: '적' }, { type: '아츠 취약', val: '20%', target: '적' }] },
            ...
            },
            {
                ...
                levels: {
                    M0: { dmg: '350%', type: ['부식 부여'], target: '적' },
                    M1: { dmg: '350%', type: ['부식 부여'], target: '적' },
                    M2: { dmg: '350%', type: ['부식 부여'], target: '적' },
            ...
            },
            {
                ...
                levels: {
                    M0: { dmg: '1650%', type: ['부식 부여'], target: '적' },
                    M1: { dmg: '1650%', type: ['부식 부여'], target: '적' },
                    M2: { dmg: '1650%', type: ['부식 부여'], target: '적' },
                    M3: { dmg: '1650%', type: ['부식 부여'], target: '적' }
                }
            }
        ],
        talents: [
    ...
    },
    {
        ...
        skill: [
            ...
            },
            {
                ...
                levels: {
                    M0: { dmg: '0%', type: [{ type: '치유', target: '팀' }, { type: '아츠 증폭', val: '15%', target: '팀' }] },
                    M1: { dmg: '0%', type: [{ type: '치유', target: '팀' }, { type: '아츠 증폭', val: '15%', target: '팀' }] },
                    M2: { dmg: '0%', type: [{ type: '치유', target: '팀' }, { type: '아츠 증폭', val: '15%', target: '팀' }] },
            ...
            },
            {
                ...
                levels: {
                    M0: { dmg: '450%', type: ['냉기 부착'], target: '적' },
                    M1: { dmg: '450%', type: ['냉기 부착'], target: '적' },
                    M2: { dmg: '450%', type: ['냉기 부착'], target: '적' },
            ...
            },
            {
                ...
                levels: {
                    M0: { dmg: '0%', type: [{ type: '냉기 증폭', val: '36%', target: '팀' }, { type: '자연 증폭', val: '36%', target: '팀' }] },
                    M1: { dmg: '0%', type: [{ type: '냉기 증폭', val: '36%', target: '팀' }, { type: '자연 증폭', val: '36%', target: '팀' }] },
                    M2: { dmg: '0%', type: [{ type: '냉기 증폭', val: '36%', target: '팀' }, { type: '자연 증폭', val: '36%', target: '팀' }] },
    ...
    },
    {
        ...
        skill: [
            ...
            },
            {
                ...
                levels: {
                    M0: { dmg: '200%', type: [{ type: '전기 취약', val: '10%', target: '적' }, { type: '열기 취약', val: '10%', target: '적' }] },
                    M1: { dmg: '200%', type: [{ type: '전기 취약', val: '10%', target: '적' }, { type: '열기 취약', val: '10%', target: '적' }] },
                    M2: { dmg: '200%', type: [{ type: '전기 취약', val: '10%', target: '적' }, { type: '열기 취약', val: '10%', target: '적' }] },
            ...
            },
            {
                ...
                levels: {
                    M0: { dmg: '340%', type: [{ type: '방어 불능 부여', target: '적' }, { type: '아츠 부착', target: '적' }], target: '적' },
                    M1: { dmg: '340%', type: [{ type: '방어 불능 부여', target: '적' }, { type: '아츠 부착', target: '적' }], target: '적' },
                    M2: { dmg: '340%', type: [{ type: '방어 불능 부여', target: '적' }, { type: '아츠 부착', target: '적' }], target: '적' },
            ...
            },
            {
                ...
                levels: {
                    M0: { dmg: '0%', type: [{ type: '전기 증폭', val: '20%', target: '팀' }, { type: '열기 증폭', val: '20%', target: '팀' }] },
                    M1: { dmg: '0%', type: [{ type: '전기 증폭', val: '20%', target: '팀' }, { type: '열기 증폭', val: '20%', target: '팀' }] },
                    M2: { dmg: '0%', type: [{ type: '전기 증폭', val: '20%', target: '팀' }, { type: '열기 증폭', val: '20%', target: '팀' }] },
    ...
    },
    {
        ...
        skill: [
            ...
            },
            {
                ...
                levels: {
                    M0: { dmg: '400%', type: ['전기 부착'], target: '적' },
                    M1: { dmg: '400%', type: ['전기 부착'], target: '적' },
                    M2: { dmg: '400%', type: ['전기 부착'], target: '적' },
            ...
            },
            {
                ...
                levels: {
                    M0: { dmg: '180%', type: ['감전 부여'], target: '적' },
                    M1: { dmg: '180%', type: ['감전 부여'], target: '적' },
                    M2: { dmg: '180%', type: ['감전 부여'], target: '적' },
        ...
        potential: [
            ...
            [{ type: ['공격력 증가'], val: '20%', desc: '펠리카가 적에게 감전을 부여했을 때, 5초 동안 공격력 +20%, 해당 효과는 최대 2스택까지 중첩됩니다.', stack: 2 }],
    ...
    },
    {
        ...
        skill: [
            ...
            },
            {
                ...
                levels: {
                    M0: { dmg: '230%', type: ['열기 부착', '연소 소모', '감전 소모'], target: '적', bonus: [{ trigger: ['연소', '감전'], val: '850%' }] },
                    M1: { dmg: '230%', type: ['열기 부착', '연소 소모', '감전 소모'], target: '적', bonus: [{ trigger: ['연소', '감전'], val: '850%' }] },
                    M2: { dmg: '230%', type: ['열기 부착', '연소 소모', '감전 소모'], target: '적', bonus: [{ trigger: ['연소', '감전'], val: '850%' }] },
            ...
            },
            {
                ...
                levels: {
                    M0: { dmg: '135%', type: ['열기 부착'], target: '적' },
                    M1: { dmg: '135%', type: ['열기 부착'], target: '적' },
                    M2: { dmg: '135%', type: ['열기 부착'], target: '적' },
            ...
            },
            {
                ...
                levels: {
                    M0: { dmg: '360%', type: ['연소 부여'], target: '적' },
                    M1: { dmg: '360%', type: ['연소 부여'], target: '적' },
                    M2: { dmg: '360%', type: ['연소 부여'], target: '적' },
    ...
    },
    {
        ...
        skill: [
            ...
            },
            {
                ...
                levels: {
                    M0: { dmg: '420%', type: [{ type: '자연 부착', target: '적' }, { type: '감속', target: '적' }] },
                    M1: { dmg: '420%', type: [{ type: '자연 부착', target: '적' }, { type: '감속', target: '적' }] },
                    M2: { dmg: '420%', type: [{ type: '자연 부착', target: '적' }, { type: '감속', target: '적' }] },
            ...
            },
            {
                ...
                levels: {
                    M0: { dmg: '380%', type: [{ type: '자연 부착', target: '적' }, { type: '냉기 부착', target: '적' }] },
                    M1: { dmg: '380%', type: [{ type: '자연 부착', target: '적' }, { type: '냉기 부착', target: '적' }] },
                    M2: { dmg: '380%', type: [{ type: '자연 부착', target: '적' }, { type: '냉기 부착', target: '적' }] },
            ...
            },
            {
                ...
                levels: {
                    M0: { dmg: '1000%', type: [{ type: '자연 부착', target: '적' }, { type: '냉기 부착', target: '적' }] },
                    M1: { dmg: '1000%', type: [{ type: '자연 부착', target: '적' }, { type: '냉기 부착', target: '적' }] },
                    M2: { dmg: '1000%', type: [{ type: '자연 부착', target: '적' }, { type: '냉기 부착', target: '적' }] },
    ...
    },
    {
        ...
        skill: [
            ...
            {
                skillType: ['강화 일반 공격'], element: 'heat', desc: '모든 공격이 열기 피해를 주며, 3단계 일반 공격은 열기 부착 상태를 부여합니다.',
                levels: {
                    M0: { dmg: '1044%' },
                    M1: { dmg: '1044%' },
                    M2: { dmg: '1044%' },
            ...
            },
            {
                ...
                levels: {
                    M0: { dmg: '140%', type: ['연소 부여'], target: '적', bonus: [{ trigger: ['녹아내린 불꽃'], val: '770%' }] },
                    M1: { dmg: '140%', type: ['연소 부여'], target: '적', bonus: [{ trigger: ['녹아내린 불꽃'], val: '770%' }] },
                    M2: { dmg: '140%', type: ['연소 부여'], target: '적', bonus: [{ trigger: ['녹아내린 불꽃'], val: '770%' }] },
            ...
            },
            {
                ...
                levels: {
                    M0: { dmg: '700%', type: ['연소 부여'], target: '적', bonus: [{ trigger: ['녹아내린 불꽃'], val: '900%' }] },
                    M1: { dmg: '700%', type: ['연소 부여'], target: '적', bonus: [{ trigger: ['녹아내린 불꽃'], val: '900%' }] },
                    M2: { dmg: '700%', type: ['연소 부여'], target: '적', bonus: [{ trigger: ['녹아내린 불꽃'], val: '900%' }] },
    ...
    },
    {
        ...
        skill: [
            ...
            },
            {
                ...
                levels: {
                    M0: { dmg: '320%', type: ['냉기 부착'], target: '적' },
                    M1: { dmg: '320%', type: ['냉기 부착'], target: '적' },
                    M2: { dmg: '320%', type: ['냉기 부착'], target: '적' },
            ...
            },
            {
                ...
                levels: {
                    M0: { dmg: '320%', type: ['냉기 부착 소모'], bonus: [{ trigger: ['냉기 부착'], base: '0%', perStack: '240%' }] },
                    M1: { dmg: '320%', type: ['냉기 부착 소모'], bonus: [{ trigger: ['냉기 부착'], base: '0%', perStack: '240%' }] },
                    M2: { dmg: '320%', type: ['냉기 부착 소모'], bonus: [{ trigger: ['냉기 부착'], base: '0%', perStack: '240%' }] },
                    M3: { dmg: '320%', type: ['냉기 부착 소모'], bonus: [{ trigger: ['냉기 부착'], base: '0%', perStack: '240%' }] }
                }
            },
            {
                skillType: ['궁극기'], element: 'cryo', cost: 240, desc: '서리 갑옷을 두르고 얼음 낫을 만들어 전방으로 3회의 베기 공격을 진행합니다. 해당 상태에서는 모든 피해에 면역됩니다. 벨 때마다 대량의 냉기 피해를 줍니다. 라스트 라이트는 자신의 배틀 스킬, 연계 스킬을 통해서만 궁극기 에너지를 획득할 수 있습니다.',
                levels: {
                    M0: { dmg: '1600%' },
                    M1: { dmg: '1600%' },
                    M2: { dmg: '1600%' },
    ...
    },
    {
        ...
        skill: [
            ...
            {
                skillType: ['강화 일반 공격'], element: 'cryo', desc: '7초 동안, 이본의 일반 공격이 강화되며 일반 공격을 할 때마다 자신의 치명타 확률이 3% 증가합니다(최대 10스택). 스택 수치가 최대로 쌓였을 경우, 자신의 치명타 피해가 60% 증가합니다. 지속 시간이 끝나기 전의 마지막 일반 공격은 강력한 일격으로 바뀌어 대량의 냉기 피해를 줍니다. 적이 동결 상태라면, 추가로 냉기 피해를 1회 준 후, 동결 상태를 소모합니다.',
                levels: {
                    M0: { dmg: '1600%', type: ['동결 소모'], bonus: [{ trigger: ['동결'], base: '600%', perStack: '0%' }] },
                    M1: { dmg: '1600%', type: ['동결 소모'], bonus: [{ trigger: ['동결'], base: '600%', perStack: '0%' }] },
                    M2: { dmg: '1600%', type: ['동결 소모'], bonus: [{ trigger: ['동결'], base: '600%', perStack: '0%' }] },
                    M3: { dmg: '1600%', type: ['동결 소모'], bonus: [{ trigger: ['동결'], base: '600%', perStack: '0%' }] }
                }
            },
            {
                ...
                levels: {
                    M0: { dmg: '400%', type: ['냉기 부착 소모', '자연 부착 소모', '동결 부여'], target: '적', bonus: [{ trigger: ['냉기 부착', '자연 부착'], base: '0%', perStack: '200%' }] },
                    M1: { dmg: '400%', type: ['냉기 부착 소모', '자연 부착 소모', '동결 부여'], target: '적', bonus: [{ trigger: ['냉기 부착', '자연 부착'], base: '0%', perStack: '200%' }] },
                    M2: { dmg: '400%', type: ['냉기 부착 소모', '자연 부착 소모', '동결 부여'], target: '적', bonus: [{ trigger: ['냉기 부착', '자연 부착'], base: '0%', perStack: '200%' }] },
                    M3: { dmg: '400%', type: ['냉기 부착 소모', '자연 부착 소모', '동결 부여'], target: '적', bonus: [{ trigger: ['냉기 부착', '자연 부착'], base: '0%', perStack: '200%' }] }
                }
            },
            {
                ...
                levels: {
                    M0: { dmg: '600%', type: ['동결 부여'], target: '적' },
                    M1: { dmg: '600%', type: ['동결 부여'], target: '적' },
                    M2: { dmg: '600%', type: ['동결 부여'], target: '적' },
        ...
        potential: [
            [{ type: ['스킬 배율 증가'], dmg: '200%', skillType: ['배틀 스킬'], desc: '연계 스킬 꽁꽁이 · υ37의 적용 범위 +20%, 추가로 에너지를 2회 더 방출하고, 피해를 준 후 추가로 15포인트의 궁극기 에너지를 획득합니다.' }],
    ...
    },
    {
        ...
        skill: [
            ...
            },
            {
                ...
                levels: {
                    M0: { dmg: '430%', type: [{ type: '갑옷 파괴', target: '적' }, { type: '스킬 게이지 회복', target: '팀' }] },
                    M1: { dmg: '430%', type: [{ type: '갑옷 파괴', target: '적' }, { type: '스킬 게이지 회복', target: '팀' }] },
                    M2: { dmg: '430%', type: [{ type: '갑옷 파괴', target: '적' }, { type: '스킬 게이지 회복', target: '팀' }] },
            ...
            },
            {
                ...
                levels: {
                    M0: { dmg: '514%', type: ['스킬 게이지 회복'] },
                    M1: { dmg: '514%', type: ['스킬 게이지 회복'] },
                    M2: { dmg: '514%', type: ['스킬 게이지 회복'] },
            ...
            },
            {
                ...
                levels: {
                    M0: { dmg: '1150%', type: ['스킬 게이지 회복'] },
                    M1: { dmg: '1150%', type: ['스킬 게이지 회복'] },
                    M2: { dmg: '1150%', type: ['스킬 게이지 회복'] },
    ...
    },
    {
        ...
        skill: [
            ...
            },
            {
                ...
                levels: {
                    M0: { dmg: '202%', type: ['감전 소모', '스킬 게이지 회복'], bonus: [{ trigger: ['감전'], val: '405%' }] },
                    M1: { dmg: '202%', type: ['감전 소모', '스킬 게이지 회복'], bonus: [{ trigger: ['감전'], val: '405%' }] },
                    M2: { dmg: '202%', type: ['감전 소모', '스킬 게이지 회복'], bonus: [{ trigger: ['감전'], val: '405%' }] },
                    M3: { dmg: '202%', type: ['감전 소모', '스킬 게이지 회복'], bonus: [{ trigger: ['감전'], val: '405%' }] }
                }
            },
            {
                ...
                levels: {
                    M0: { dmg: '350%', type: ['스킬 게이지 회복'] },
                    M1: { dmg: '350%', type: ['스킬 게이지 회복'] },
                    M2: { dmg: '350%', type: ['스킬 게이지 회복'] },
            ...
            },
            {
                ...
                levels: {
                    M0: { dmg: '900%', type: [{ type: '전기 부착', target: '적' }, '전기 부착 소모', { type: '감전 부여', target: '적' }] },
                    M1: { dmg: '900%', type: [{ type: '전기 부착', target: '적' }, '전기 부착 소모', { type: '감전 부여', target: '적' }] },
                    M2: { dmg: '900%', type: [{ type: '전기 부착', target: '적' }, '전기 부착 소모', { type: '감전 부여', target: '적' }] },
    ...
    },
    {
        ...
        skill: [
            ...
            },
            {
                ...
                levels: {
                    M0: { dmg: '450%', type: ['냉기 부착 소모', { type: '스킬 게이지 회복' }, { type: '동결 부여', target: '적' }] },
                    M1: { dmg: '450%', type: ['냉기 부착 소모', { type: '스킬 게이지 회복' }, { type: '동결 부여', target: '적' }] },
                    M2: { dmg: '450%', type: ['냉기 부착 소모', { type: '스킬 게이지 회복' }, { type: '동결 부여', target: '적' }] },
            ...
            },
            {
                ...
                levels: {
                    M0: { dmg: '480%', type: ['스킬 게이지 회복'] },
                    M1: { dmg: '480%', type: ['스킬 게이지 회복'] },
                    M2: { dmg: '480%', type: ['스킬 게이지 회복'] },
            ...
            },
            {
                ...
                levels: {
                    M0: { dmg: '980%', type: [{ type: '스킬 게이지 회복' }, { type: '냉기 부착', target: '적' }] },
                    M1: { dmg: '980%', type: [{ type: '스킬 게이지 회복' }, { type: '냉기 부착', target: '적' }] },
                    M2: { dmg: '980%', type: [{ type: '스킬 게이지 회복' }, { type: '냉기 부착', target: '적' }] },
    ...
    },
    {
        ...
        skill: [
            ...
            },
            {
                ...
                levels: {
                    M0: { dmg: '320%', type: ['열기 부착'], target: '적' },
                    M1: { dmg: '320%', type: ['열기 부착'], target: '적' },
                    M2: { dmg: '320%', type: ['열기 부착'], target: '적' },
            ...
            },
            {
                ...
                levels: {
                    M0: { dmg: '180%', type: ['스킬 게이지 회복'] },
                    M1: { dmg: '180%', type: ['스킬 게이지 회복'] },
                    M2: { dmg: '180%', type: ['스킬 게이지 회복'] },
                    M3: { dmg: '180%', type: ['스킬 게이지 회복'] }
                }
            },
            {
        ...
        potential: [
            [{ type: ['공격력 증가'], val: '50%', desc: '스킬을 사용하여 스킬 게이지를 회복했을 때, 공격력 +10%, 10초 동안 지속, 최대 중첩 5스택.' }],
            [{ type: ['스탯'], stats: '민첩', val: 10 }, { type: ['스탯'], stats: '지능', val: 10, desc: '민첩 +10, 지능 +10' }],
