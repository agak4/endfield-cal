...
const AppTooltip = {
    ...
    HIGHLIGHTS: {
        ...
        '방어 불능': 'kw-phys', '물리 이상': 'kw-phys', '강타': 'kw-phys', '띄우기': 'kw-phys', '넘어뜨리기': 'kw-phys', '강제 띄우기': 'kw-phys', '강제 넘어뜨리기': 'kw-phys', '갑옷 파괴': 'kw-phys', '오리지늄 결정': 'kw-phys',
        '쇄빙': 'kw-phys',
    ...
    renderSkillTooltip(skillType, skillDataOriginal, opData, extraHtml = '', activeEffects = [], st = null, overrideLevel = null) {
        ...
        // 4. 추가 효과 조건
        if (triggerTags) {
            attrLines.push(`<div class="tooltip-bullet-point">추가 효과 조건: ${triggerTags}</div>`);
        }
