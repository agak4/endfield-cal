...
const DATA_WEAPONS = [
...

  {
    ...
    traits: [
      ...
      { type: ['공격력 증가'], valByLevel: ['10%', '12%', '14%', '16%', '18%', '20%', '22%', '24%', '28%'] },
      { type: ['공격력 증가'], valByLevel: ['5%', '6%', '7%', '8%', '9%', '10%', '11%', '12%', '14%'], target: '팀', trigger: ['스킬 게이지 회복', '연타'] }
    ]
  },
...

  {
    ...
    traits: [
      ...
      { type: ['물리 피해'], valByLevel: ['2.5%', '3%', '3.5%', '4%', '4.5%', '5%', '5.5%', '6%', '7%'], target: '팀', trigger: ['스킬 게이지 회복'] }
    ]
  },

  {
    ...
    traits: [
      ...
      { type: ['물리 피해'], valByLevel: ['36%', '43.2%', '50.4%', '57.6%', '64.8%', '72%', '79.2%', '86.4%', '100.8%'], trigger: ['오리지늄 봉인', '동결 부여', '냉기 부착'], skilltype: ['배틀 스킬', '궁극기'] }
    ]
  },
...

  {
    ...
    traits: [
      ...
      { type: ['열기 피해'], valByLevel: ['8%', '9.6%', '11.2%', '12.8%', '14.4%', '16%', '17.6%', '19.2%', '22.4%'], trigger: ['연소 부여', '부식 부여', '열기 부착', '자연 부착'] },
      { type: ['자연 피해'], valByLevel: ['8%', '9.6%', '11.2%', '12.8%', '14.4%', '16%', '17.6%', '19.2%', '22.4%'], trigger: ['연소 부여', '부식 부여', '열기 부착', '자연 부착'] }
    ]
  },

  {
    ...
    traits: [
      ...
      { type: ['공격력 증가'], valByLevel: ['7.5%', '9%', '10.5%', '12%', '13.5%', '15%', '16.5%', '18%', '21%'], trigger: ['강타', '띄우기', '넘어뜨리기', '강제 띄우기', '강제 넘어뜨리기', '갑옷 파괴'] }
    ]
  },

  {
    ...
    traits: [
      ...
      { type: ['물리 피해'], valByLevel: ['12%', '14.4%', '16.8%', '19.2%', '21.6%', '24%', '26.4%', '28.8%', '33.6%'], trigger: ['띄우기'], skilltype: ['궁극기'] }
    ]
  },

  {
    ...
    traits: [
      ...
      { type: ['열기 피해'], valByLevel: ['3%', '3.6%', '4.2%', '4.8%', '5.4%', '6%', '6.6%', '7.2%', '8.4%'], target: '팀', trigger: ['스킬 게이지 회복'] },
      { type: ['전기 피해'], valByLevel: ['3%', '3.6%', '4.2%', '4.8%', '5.4%', '6%', '6.6%', '7.2%', '8.4%'], target: '팀', trigger: ['스킬 게이지 회복'] }
    ]
  },

  {
    ...
    traits: [
      ...
      { type: ['물리 피해'], valByLevel: ['4%', '7.2%', '10.4%', '13.6%', '16.8%', '20%', '23.2%', '26.4%', '31.2%'] },
      { type: ['스탯'], stat: '부스탯', valByLevel: ['5%', '6%', '7%', '8%', '9%', '10%', '11%', '12%', '14%'] },
      { type: ['공격력 증가'], valByLevel: ['7.5%', '9%', '10.5%', '12%', '13.5%', '15%', '16.5%', '18%', '21%'], trigger: ['연소 소모', '감전 소모', '동결 소모', '부식 소모'] }
    ]
  },

  {
    ...
    traits: [
      ...
      { type: ['공격력 증가'], valByLevel: ['5%', '6%', '7%', '8%', '9%', '10%', '11%', '12%', '14%'] },
      { type: ['받는 냉기 피해'], valByLevel: ['8%', '9.6%', '11.2%', '12.8%', '14.4%', '16%', '17.6%', '19.2%', '22.4%'], target: '적', trigger: ['동결 부여', '냉기 부착'] }
    ]
  },
...

  {
    ...
    traits: [
      ...
      { type: ['냉기 피해'], valByLevel: ['10%', '12%', '14%', '16%', '18%', '20%', '22%', '24%', '28%'], trigger: ['냉기 부착'] },
      { type: ['냉기 피해'], valByLevel: ['20%', '24%', '28%', '32%', '36%', '40%', '44%', '48%', '56%'], trigger: ['냉기 부착'] }
    ]
  },
...

  {
    ...
    traits: [
      ...
      { type: ['물리 피해'], valByLevel: ['20%', '24%', '28%', '32%', '36%', '40%', '44%', '48%', '56%'], trigger: ['강타', '갑옷 파괴'] }
    ]
  },

  {
    ...
    traits: [
      ...
      { type: ['공격력 증가'], valByLevel: ['18%', '21.6%', '25.2%', '28.8%', '32.4%', '36%', '39.6%', '43.2%', '50.4%'], trigger: ['열기 부착', '전기 부착', '냉기 부착', '자연 부착'] }
    ]
  },
